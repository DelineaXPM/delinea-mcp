...
- **enabled_tools** - List of tool names to register. An empty list enables all tools. it is highly recommended to enalbe tools selectively per use case or task. see `docs/` folder for some examples.
