...
@pytest.mark.parametrize("func,args,msg", [
    ...
    (tools.user_management, ("reset_password",), "user_id and data required for reset_password"),
...
@pytest.mark.parametrize("func,args,msg", [
    ...
    (tools.user_role_management, ("remove", 1, None), "role_ids required for remove"),
])
...
@pytest.mark.parametrize("func,args,msg", [
    ...
    (tools.user_group_management, ("remove", 1, None), "group_ids required for remove"),
])
...
@pytest.mark.parametrize("func,args,msg", [
    ...
    (tools.group_role_management, ("remove", 1, None), "role_ids required for remove"),
])
...
@pytest.mark.parametrize("func,args,msg", [
    ...
    (tools.folder_management, ("update",), "folder_id and data required for update"),
